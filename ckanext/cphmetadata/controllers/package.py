...
class MetadataPackageController(PackageController):
    
    '''
    Overriding _save_new as we want to skip adding data if save value is 'go-resource'.
    Mostly copied original implementation of _save_new
    '''
    def _save_new(self, context, package_type=None):
        ...
        #set phase to None to skip adding data phase
        if 'save' in request.params and request.params['save'] == 'go-resource':
            ckan_phase = None
